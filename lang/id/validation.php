...
return [
    ...
    'attributes' => [
        ...
        'tmt_yayasan' => 'TMT Yayasan',
        'tmt_satker' => 'TMT Satuan Kerja',

        'work_unit_id' => 'Satuan kerja',
        'position_id' => 'Jabatan',
        'employment_status_id' => 'Status kepegawaian',
        'additional_duty_id' => 'Referensi tugas tambahan',
        'foundation_start_date' => 'TMT Yayasan',
        'unit_start_date' => 'TMT Satuan Kerja',
        ...
        'certificate_date' => 'Tanggal ijazah',
        'is_highest' => 'Pendidikan tertinggi',

        'decree_type_id' => 'Jenis SK',
        'decree_number' => 'Nomor SK',
        'effective_date' => 'TMT',
        'issued_date' => 'Tanggal penetapan',
        'issued_place' => 'Tempat penetapan',
        'employee_ids' => 'Daftar GTK',
        'employee_id' => 'GTK',

        'cc_list' => 'Tembusan',
        'letterhead' => 'Kop surat',
        'foundation' => 'Data yayasan',
        'template_view' => 'Template SK',
        'requires_decree' => 'Perlu nomor SK',
        'requires_effective_date' => 'Wajib TMT',
        'applicable_levels' => 'Jenjang berlaku',
        'head_name' => 'Nama pimpinan',
        'head_nigy' => 'NIGY pimpinan',
        'appointed_as' => 'Ditugaskan sebagai',
        'hour_equivalence' => 'Konversi jam',
        'quota_per_unit' => 'Kuota per satuan kerja',
        'consideration_weighing' => 'Menimbang',
        'consideration_recalling' => 'Mengingat',
        'consideration_observing' => 'Memperhatikan',
    ],
];
